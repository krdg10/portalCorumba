                ...
                <div className="col-md-9 text-justify">
                    ...
                    <p>A área do atual município de Corumbá foi explorada pela primeira vez por volta de 1524 pelo português Aleixo Garcia, que ali chegou em busca de ouro. Com o nome de origem tupi-guarani Curupah – que significa “lugar distante” – e,
                      ...
                      <figure className="figure fix2">
                         <img src={Img1} alt="Corumbá" className="histimg img-fluid" />
                     ...
                     o porto de Corumbá com sua posição geográfica privilegiada, tornou-se um importante centro econômico. 
                      ...
                      <figure className="figure fix2">
                        <img src={Img2} alt="Corumbá" className="histimg img-fluid" />
                    ...
                    batalhas do conflito.Durante a ocupação a navegação pelo rio Paraguai foi interrompida o que desarticulou o comércio local. A cidade foi
                     ...
                     <figure className="figure fix2">
                      <img src={Img3} alt="Corumbá" className="histimg img-fluid" />
                    ...
                    <figure className="figure fix2">
                         <img src={Img4} alt="Corumbá" className="histimg img-fluid" />
                    ...
                    <figure className="figure fix2">
                         <img src={Img5} alt="Corumbá" className="histimg img-fluid" />
                    ...
                    <figure className="figure fix2">
                         <img src={Img6} alt="Corumbá" className="histimg img-fluid" />
                            <figcaption className="figure-caption">
                   ...
                   <figure className="figure fix2">
                       <img src={Img7} alt="Corumbá" className="histimg img-fluid " />
                          <figcaption className="figure-caption">
                   ...
                   <figure className="figure fix2">
                      <img src={Img8} alt="Corumbá" className="histimg img-fluid" />
                        <figcaption className="figure-caption">
                       </figcaption>
                   </figure>
                  ...
                  <div id="" className="col-md-3 background squarehist">     
                      <h5>Anuncie aqui!</h5>
